...
CREATE TABLE IF NOT EXISTS bronze.product_suppliers (
    ...
    supplier_id              integer NOT NULL REFERENCES bronze.suppliers(supplier_id),
...
CREATE TABLE IF NOT EXISTS bronze.inventory (
    ...
    product_id        integer NOT NULL REFERENCES bronze.products(product_id),
    location_id       integer NOT NULL REFERENCES bronze.locations(location_id),
...
CREATE TABLE IF NOT EXISTS bronze.sales_orders (
    ...
    customer_id        integer NOT NULL REFERENCES bronze.customers(customer_id),
    location_id        integer NOT NULL REFERENCES bronze.locations(location_id),
...
CREATE TABLE IF NOT EXISTS bronze.sales_order_lines (
    ...
    order_id           integer NOT NULL REFERENCES bronze.sales_orders(order_id),
    product_id         integer NOT NULL REFERENCES bronze.products(product_id),
...
CREATE TABLE IF NOT EXISTS bronze.purchase_order_lines (
    line_id             integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    po_id               integer NOT NULL REFERENCES bronze.purchase_orders(po_id),
    product_id          integer NOT NULL REFERENCES bronze.products(product_id),
    qty_ordered         numeric(10,2),

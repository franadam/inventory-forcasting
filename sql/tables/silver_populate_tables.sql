...
TRUNCATE TABLE
    silver.inventory_movements,
    silver.sales_order_lines,
    silver.sales_orders,
    silver.purchase_order_lines,
    silver.purchase_orders,
    silver.inventory,
    silver.product_suppliers,
    silver.customers,
    silver.products,
    silver.suppliers,
    silver.locations
...
INSERT INTO silver.locations (location_code, location_name, location_type, address, city, postal_code, region, storage_capacity_m3, is_active) VALUES
...
INSERT INTO silver.suppliers (supplier_code, supplier_name, contact_name, email, country, avg_lead_time_days, reliability_score, is_active) VALUES
...
INSERT INTO silver.products (sku, product_name, category, subcategory, brand, unit_of_measure, unit_weight_kg, unit_price_eur, lead_time_days, min_order_qty, is_active) VALUES
-- Sanitair - Toiletten
...
INSERT INTO silver.customers (customer_code, customer_name, customer_type, address, city, postal_code, region, is_professional, is_active) VALUES
...
INSERT INTO silver.product_suppliers (product_id, supplier_id, supplier_unit_cost_eur, supplier_lead_time_days, is_preferred) VALUES
...
INSERT INTO silver.inventory (product_id, location_id, qty_on_hand, qty_reserved, min_stock_level, reorder_point, max_stock_level) VALUES
...
INSERT INTO silver.purchase_orders (supplier_id, location_id, created_at, expected_delivery, actual_delivery, status, total_cost_eur) VALUES
...
INSERT INTO silver.purchase_order_lines (po_id, product_id, qty_ordered, qty_received, unit_cost_eur, line_total_eur) VALUES
-- PO 1 (Grohe → WH-LGE)
...
INSERT INTO silver.sales_orders (customer_id, location_id, order_ts, status, source, total_amount_eur) VALUES
-- October 2024
...
INSERT INTO silver.sales_order_lines (order_id, product_id, qty_ordered, qty_fulfilled, unit_price_eur, line_total_eur) VALUES
...
INSERT INTO silver.sales_order_lines (order_id, product_id, qty_ordered, qty_fulfilled, unit_price_eur, line_total_eur)
SELECT
    o.order_id,
    p.product_id,
    qty,
...
JOIN silver.sales_orders o ON o.order_id = v.oid
JOIN silver.products p ON p.product_id = v.pid;
...
FROM silver.sales_order_lines AS sol
JOIN silver.sales_orders AS so
...
FROM silver.purchase_order_lines AS pol
JOIN silver.purchase_orders AS po

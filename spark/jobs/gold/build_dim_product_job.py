...
from spark.transformations.gold.dim_product import prepare_internal_products, reorder_dim_product_columns
...
def build_dim_product() -> DataFrame:
    ...
    save_into_db(schema='gold', table='dim_product', dataframe=dim_product_df, mode="append")

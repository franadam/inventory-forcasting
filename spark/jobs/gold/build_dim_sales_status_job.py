...
from spark.transformations.gold.dim_sales_status import prepare_internal_sales_status, reorder_dim_sales_status_columns
...
def build_dim_sales_status() -> DataFrame:
    ...
    save_into_db(schema='gold', table='dim_sales_status',
                 dataframe=dim_sales_status_df, mode="append")

...
from spark.transformations.gold.dim_sales_channel import prepare_internal_sale_channel, reorder_dim_sales_channel_columns
...
def build_dim_sales_channel() -> DataFrame:
    ...
    save_into_db(schema='gold', table='dim_sales_channel',
                 dataframe=dim_sales_channel_df, mode="append")

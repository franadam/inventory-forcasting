...
from spark.common.clean_utils import clean_ids, clean_cost, standardize_date, standardize_datetime, trim_lower_column
...
def clean_purchase_orders() -> DataFrame:
    ...
    df = read_postgresql_table(
        spark=spark, schema='bronze', table='purchase_orders')
    ...
    save_into_db(schema='staging', table='purchase_orders',
